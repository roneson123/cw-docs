...
In order to configure and use Apple Pay with O-In, you need to prepare some business accounts and tools as follows:
...
5. You should store this file in an accessible place. The domain verification step is not completed yet. We're going to get back to this as we configure Apple Pay on the O-In.
...
## Enable Apple Pay in O-In Dashboard

After configuring Apple Developer Account and Checkout.com, we need to do some steps on the O-In dashboard to make Apple Pay fully functional.

1. Head over your restaurant settings in your O-In dashboard.
